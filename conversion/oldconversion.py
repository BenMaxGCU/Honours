...
filepath = 'B:/Downloads/CrackForest-dataset/gtNames/0.mat'
...
####################################################################
#Read cjdata struct
cjdata = f['groundTruth'] #<HDF5 group "/cjdata" (5 members)>
...
tumorBorder = np.array(cjdata.get('Boundaries'))[0] #Use [0] indexing - convert from 2D array to 1D array.

tumorMask = np.array(cjdata.get('Segmentation'))
...
im.save('B:/Downloads/CrackForest-dataset/gtNames/png_images/0.png')
